...
if __name__ == '__main__':
    ...
    train_data= pd.read_csv('ratings_train.txt',sep='\t', encoding='utf-8', header=0)
    eval_data= pd.read_csv('ratings_test.txt',sep='\t', encoding='utf-8', header=0)
    predict_data= pd.read_csv('ratings_predict.txt',sep='\t', encoding='utf-8', header=0)
    print('The number of train set: {} \nThe number of eval set: {}'.format(train_data.shape[0],eval_data.shape[0]))
